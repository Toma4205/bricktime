...
class AnimatedFab extends StatefulWidget {
  ...
  final void Function(IconData) onClick;
...
class _AnimatedFabState extends State<AnimatedFab>
  ...
  void initState() {
    ...
    _colorAnimation = new ColorTween(begin: Colors.deepOrangeAccent, end: Colors.deepOrange)
        ...
        builder: (BuildContext context, Widget child) {
          return new Stack(
            ...
            children: <Widget>[
              ...
              _buildOption(Icons.list, -math.pi / 3),
              _buildOption(Icons.access_time, -2 * math.pi / 3),
              _buildOption(Icons.block, math.pi),
              _buildFabCore(),
            ],
          );
        },
  ...
  Widget _buildExpandedBackground() {
    ...
    return new Container(
      height: size,
      width: size,
      decoration: new BoxDecoration(shape: BoxShape.circle, color: Colors.deepOrange),
    );
  }
