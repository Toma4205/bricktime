...
class Player {
  ...
  Player({this.id, this.first_name, this.last_name, this.short_name, this.teamId, this.teamAbrev, this.teamCity, this.teamName, this.teamConf, this.position, this.price, this.owner, this.list_games_real_stats, this.list_games_fantasy_stats, this.last_game_real_stats, this.last_game_fantasy_stats});
}
